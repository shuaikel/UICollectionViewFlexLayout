...
open class UICollectionViewFlexLayout: UICollectionViewFlowLayout {
    ...
    private func prepareItemAttributes() {
        ...
        for section in 0..<collectionView.numberOfSections {
            ...
            if let sectionHeaderAttribute = self.prepareSectionHeaderAttributes(section) {
                offset.y += sectionHeaderAttribute.frame.maxY
            }
            // item
    ...
    private func prepareSectionHeaderAttributes(_ section: Int) -> UICollectionViewLayoutAttributes?{
        ...
        let sectionHeaderAttribute = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader,
